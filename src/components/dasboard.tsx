...
const Dashboard: React.FC = () => {
  return (
    <SidebarProvider>
      <div className="flex w-full h-screen bg-gray-200"> {/* Asegura que ocupe toda la pantalla */}

        {/* Sidebar con tamaño dinámico */}
        <div className="w-1/5 min-w-[250px] lg:w-1/6">
          <SocialSphereSidebar />
        </div>

        {/* Contenedor principal ahora ocupa todo el ancho disponible */}
        <div className="flex-1 flex flex-col bg-white rounded-2xl shadow-lg p-6 min-h-screen overflow-y-auto w-full">
          <CommunityBanner />

          {/* Carrusel con ancho completo */}
          <div className="p-6 w-full max-w-6xl mx-auto">
            <HighlightedVoteCarousel />
          </div>

          {/* Sección de publicaciones con mayor ancho */}
