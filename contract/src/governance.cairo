...
// Given that this contract is the basis of the governance system, this contract can always be
// modified to add additional governance functions with components.
...
trait IGovernance<TContractState> {
    ...
    // Set the quorum of all proposals for this DAO. Only the DAO Owner or sub-committee members can
    // call this function. There must be a cooldown period AND all proposals must be closed before
    // the quorum can be changed.
