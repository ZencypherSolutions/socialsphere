...
//     fn create_proposal(self: TContractState, description: felt252) -> u32;

//     // Cancel a proposal, only the DAO Owner or proposed member can cancel a proposal. 
//     fn cancel_proposal(self: TContractState, proposal_id: felt252) -> bool;

//     // Execute the proposal, once it reaches the quorum at the end of the voting period. 
//     fn execute_proposal(self: TContractState, proposal_id: felt252) -> bool;
