...
trait IDaoBuilder<TContractState> {
    ...
    // Temporary pauses/unpauses creation of new DAOs. Only the Core Team or the deployer of dao_builder can call these functions.
    fn pause_creation(ref self: TContractState) -> bool;
    fn resume_creation(ref self: TContractState) -> bool;

    // This function can be called to update the DAO configuration of an existing DAO. Only admin of the DAO can call this function. 
